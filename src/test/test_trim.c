...
Suite *test_trim(void) {
  Suite *s = suite_create("\033[46m-=S21_TRIM=-\033[0m");
  TCase *tc = tcase_create("trim_tc");

  tcase_add_test(tc, test_trim_1);
  tcase_add_test(tc, test_trim_1_2);
  tcase_add_test(tc, test_trim_1_3);
  ...
  tcase_add_test(tc, test_trim_12);
  tcase_add_test(tc, test_trim_13);
